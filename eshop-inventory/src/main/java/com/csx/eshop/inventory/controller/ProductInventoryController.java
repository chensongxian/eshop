...
import com.csx.eshop.inventory.request.ProductInventoryCacheRefreshRequest;
import com.csx.eshop.inventory.request.ProductInventoryDBUpdateRequest;
import com.csx.eshop.inventory.request.Request;
import com.csx.eshop.inventory.service.ProductInventoryService;
import com.csx.eshop.inventory.service.RequestAsyncProcessService;
import com.csx.eshop.inventory.vo.Response;
...
public class ProductInventoryController {
     ...
     * 更新商品库存
     */
    @RequestMapping(value = "/updateProductInventory",method = RequestMethod.POST,consumes = "application/json")
    ...
    public ProductInventory getProductInventory(@PathVariable(name = "productId") Integer productId) {
